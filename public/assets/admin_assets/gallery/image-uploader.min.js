    ...
    e.fn.imageUploader = function (t) {
        let n,
            i = {
                ...
                extensions: [".xlsx",".doc",".pdf",".jpg", ".jpeg", ".png", ".gif", ".svg"],
                mimes: ["application/vnd.openxmlformats-officedocument.spreadsheetml.sheet","application/msword","application/pdf","image/jpeg", "image/png", "image/gif", "image/svg+xml"],
                maxSize: void 0,
                maxFiles: void 0,
            },
            a = this,
        ...
        let o = function () {
                ...
                n = e("<input>", { type: "file", id: a.settings.imagesInputName + "-" + h(), name: a.settings.imagesInputName + "[]", accept: a.settings.extensions.join(","), multiple: "",class:"mario" }).appendTo(t);
                e("<div>", { class: "uploaded" }).appendTo(t);
                let i = e("<div>", { class: "upload-text" }).appendTo(t);
                e("<i>", { class: "icon-material-outline-cloud" }).appendTo(i), e("<span>", { text: a.settings.label }).appendTo(i);
                return (
            ...
            l = function (t, i, o) {
                ...
                // custom addition
                let fileExtension = t.replace(/^.*\./, '');
                var url = t;
                var filename = url.substring(url.lastIndexOf('/')+1);
             
                let dfile=t;
                if(fileExtension=="pdf"){
                    t = mainurl+"/assets/admin_assets/gallery/pdf.png";                   
                }
                else if(fileExtension=="doc"){
                     t = mainurl+"/assets/admin_assets/gallery/doc.png"; 
                }
                else if(fileExtension=="xlsx"){
                     t = mainurl+"/assets/admin_assets/gallery/xlsx.png"; 
                }
                ...
                if (o) {
                    ...
                    // custom addition
                    e("<a>", { href:dfile, class:'download-file',download:"proposed_file_name" },"</a>").appendTo(l);
                    // custom addition ends
            ...
            u = function (t, n) {
                ...
                e(n).each(function (e, t) {
                    ...
                    if(ext=="pdf"){
                        ...
                        x = mainurl+"/assets/admin_assets/gallery/pdf.png";                   
                    }
                    else if(ext=="doc"){

                         x = mainurl+"/assets/admin_assets/gallery/doc.png"; 
                    }
                    else if(ext=="xlsx"){

                         x = mainurl+"/assets/admin_assets/gallery/xlsx.png"; 
                    }
                    else{
                    ...
                    s.items.add(t), i.append(l(x, s.items.length - 1), !1);
                }),
