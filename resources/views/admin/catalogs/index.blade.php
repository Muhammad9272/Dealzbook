    ...
    <div class="page-content">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <input type="hidden" id="headerdata" value="{{ __('Catalog') }}">
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i  class="fa fa-list"></i>
                                        <span class="caption-subject  sbold uppercase">Catalogs</span>
                                        
                                    </div>
                                    <div class="actions">

                                                <div class="btn-group">
                                                    <a id="add-data" class="btn sbold green add" data-toggle="modal" href="#modal1" data-href="{{route('admin-catalogs-create')}}" href="#modal1"> Add New
...
<script src="{{ asset('assets/admin_assets/img_upload/imgUpload.js') }}" type="text/javascript"></script>
    ...
    <script type="text/javascript">
        ...
        var table = $('#geniustable').DataTable({
               ...
               processing: true,
               serverSide: true,
               ajax: '{{ route('admin-catalogs-datatables') }}',
               columns: [
                        { data: 'name', name: 'name' },
                        { data: 'slug', name: 'slug' },
