    ...
    <div class="page-content">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <input type="hidden" id="headerdata" value="{{ __('Faqs') }}">
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i  class="fa fa-list"></i>
                                        <span class="caption-subject  sbold uppercase">Faqs</span>
                                        
                                    </div>
                                    <div class="actions">

                                                <div class="btn-group">
                                                    <a id="add-data" class="btn sbold green add" data-toggle="modal" href="#modal1" data-href="{{route('admin-faqs-create')}}" href="#modal1"> Add New
