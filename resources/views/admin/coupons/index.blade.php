                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject  sbold uppercase">Coupons</span>
                                        
                                    </div>
                                    <div class="actions">

                                                <div class="btn-group">
                                                    <a id="add-data" class="btn sbold green add" data-toggle="modal" href="#modal1" data-href="{{route('admin-coupon-create')}}" href="#modal1"> Add New
