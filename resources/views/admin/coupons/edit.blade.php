           ...
           @include('admin.layouts.modal-scripts')   
            ...
            <form id="geniusformdata" action="{{ route('admin-coupon-update',$data->id) }}" method="POST" enctype="multipart/form-data" class="form-horizontal formcatalog">
               {{csrf_field()}}
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-body">
                           ...
                           {{--  <div class="form-group last">
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label" >Start Date<span class="sm-span">Leave unchecked for unlimited time</span></label>
                                 <div class="col-md-1 d-inline-flex mt-10">
                                    <input type="checkbox" name="for_unlimited_stime" value="1" class="start_date_chk" {{$data->start_at?"checked":""}} >
                                 </div>
                                <div class="col-md-8 d-inline-flex start_date_status {{$data->start_at?"":"not-show"}}">
                                    <input type="date" class="form-control" value="{{$data->start_at }}" name="start_at">  
                                            ...
                                            <div class="fileinput fileinput-new" data-provides="fileinput">
                                                ...
                                                <div>
                                                    <span class="btn default btn-file" onclick="filemanager.selectFile('profile-photo')">
                                                        ...
                                                        <input id="profile-photo" type="text" name="cover_photo" value="{{$data->image}}" > 
                                                    </span>
