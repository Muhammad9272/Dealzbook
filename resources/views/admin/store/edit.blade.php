            ...
            <form id="geniusformdata" action="{{ route('admin-store-update',$data->id) }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
               {{csrf_field()}}
               ...
               <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-body">
                            <div class="form-group">
                                <label class="col-md-3 control-label" >Name</label>
                                <div class="col-md-8 d-inline-flex">
                                    <input type="text" class="form-control" value="{{$data->getTranslation('name', 'ar')}}" name="arabicName" required="">  
                            ...
                            <div class="row">
                                ...
                                <div class="form-group last">
                                    <label class="control-label col-md-3">Page Description</label>
                                    <div class="col-md-8">
                                          <textarea name="arabic_description" height="450" class="summernote2 nic" style="width: 100%;">
                ...
                <div class="row">  
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div class="col-md-8 d-inline-flex">
                            <input type="text" class="form-control"  name="websiteLink" value="{{$data->website_link}}">  
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div class="col-md-8 d-inline-flex">
                            <input type="text" class="form-control" value="{{$data->facebook_link}}"  name="facebookLink">  
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div class="col-md-8 d-inline-flex">
                            <input type="text" class="form-control" value="{{$data->twitter_link}}"  name="twitterLink">  
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div class="col-md-8 d-inline-flex">
                            <input type="text" class="form-control" value="{{$data->instagram_link}}"  name="instagramLink" >  
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div class="col-md-8 d-inline-flex">
                            <input type="text" class="form-control" value="{{$data->youtube_link}}"  name="youtubeLink">  
