    ...
    <div class="portlet light bordered">
        <div class="portlet-title">
            <div class="caption">
                ...
                <span class="caption-subject font-red-sunglo bold uppercase">Seo Tools</span>
                ...
                <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 d-inline-flex">
                            <input type="text" class="form-control" value="{{$data->seo_title}}" name="seo_title" required="">  
                    ...
                    <div class="form-group">
                        <label class="col-md-3 control-label" >Seo Title</label>
                        <div class="col-md-8 d-inline-flex">
                            <input type="text" class="form-control" value="{{$data->getTranslation('seo_title', 'ar')}}" name="arabic_seo_title" required="">  
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8 d-inline-flex">
                            <textarea class="form-control" name="arabic_seo_description">
                                {!! $data->getTranslation('seo_description', 'ar') !!}
                            </textarea>
